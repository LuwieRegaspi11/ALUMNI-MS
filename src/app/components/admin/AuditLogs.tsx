...
import { Shield, Eye, Edit, Trash2, UserPlus, FileText, DollarSign, Calendar } from 'lucide-react';
...
const mockLogs: AuditLog[] = [
  {
    id: '1',
    timestamp: '2026-05-05T14:23:15',
    user: 'Admin User',
    role: 'Admin',
    action: 'Verified Donation',
    module: 'Donations',
    details: 'Approved donation #D-1234 from Oishi Regaspi (₱5,000)',
    ipAddress: '192.168.1.100',
    severity: 'Medium'
  },
  {
    id: '2',
    timestamp: '2026-05-05T13:45:22',
    user: 'Admin User',
    role: 'Admin',
    action: 'Modified Alumni Record',
    module: 'Alumni Database',
    details: 'Updated employment status for Rui Delmo (ID: ALM-2019-0234)',
    ipAddress: '192.168.1.100',
    severity: 'High'
  },
  {
    id: '3',
    timestamp: '2026-05-05T12:30:08',
    user: 'Faculty Member',
    role: 'Faculty',
    action: 'Viewed Alumni Directory',
    module: 'Reports',
    details: 'Generated department-specific alumni list for CSE',
    ipAddress: '192.168.1.105',
    severity: 'Low'
  },
  {
    id: '4',
    timestamp: '2026-05-05T11:15:33',
    user: 'Admin User',
    role: 'Admin',
    action: 'Created Event',
    module: 'Events',
    details: 'Published new event: Alumni Homecoming 2026',
    ipAddress: '192.168.1.100',
    severity: 'Medium'
  },
  {
    id: '5',
    timestamp: '2026-05-05T10:20:45',
    user: 'Admin User',
    role: 'Admin',
    action: 'Deployed Survey',
    module: 'Tracer Surveys',
    details: 'Sent employment tracer survey to 234 CSE alumni',
    ipAddress: '192.168.1.100',
    severity: 'Medium'
  },
  {
    id: '6',
    timestamp: '2026-05-05T09:05:12',
    user: 'Admin User',
    role: 'Admin',
    action: 'Deleted Alumni Record',
    module: 'Alumni Database',
    details: 'Removed duplicate record for Luwie Enolpe (ID: ALM-2021-0445)',
    ipAddress: '192.168.1.100',
    severity: 'High'
  }
];
