...
const mockRepresentatives: Representative[] = [
  {
    id: '1',
    name: 'Luwie Enolpe',
    email: 'luwie@alumni.com',
    batchYear: 2021,
    department: 'CSE',
    program: 'BSIT',
    assignedDate: '2026-01-15',
    verificationsCount: 12,
    profileImage: 'https://ui-avatars.com/api/?name=Luwie+Enolpe&background=10b981&color=fff',
    status: 'Active'
  },
  {
    id: '2',
    name: 'Ashi Capistrano',
    email: 'ashi@alumni.com',
    batchYear: 2021,
    department: 'CSE',
    program: 'BSCS',
    assignedDate: '2026-01-20',
    verificationsCount: 8,
    profileImage: 'https://ui-avatars.com/api/?name=Ashi+Capistrano&background=a855f7&color=fff',
    status: 'Active'
  },
  {
    id: '3',
    name: 'Rui Elmido',
    email: 'rui.elmido@alumni.com',
    batchYear: 2020,
    department: 'CTHM',
    program: 'BSHM',
    assignedDate: '2026-02-01',
    verificationsCount: 15,
    profileImage: 'https://ui-avatars.com/api/?name=Rui+Elmido&background=ef4444&color=fff',
    status: 'Active'
  },
  {
    id: '4',
    name: 'Oii Partosa',
    email: 'oii@alumni.com',
    batchYear: 2019,
    department: 'BAA',
    program: 'BSA',
    assignedDate: '2026-01-10',
    verificationsCount: 20,
    profileImage: 'https://ui-avatars.com/api/?name=Oii+Partosa&background=eab308&color=fff',
    status: 'Active'
  }
];
