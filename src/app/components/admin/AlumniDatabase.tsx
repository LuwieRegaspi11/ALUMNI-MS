...
import { Search, Filter, Download, UserPlus, Eye, Edit, Trash2, FileText, FileSpreadsheet } from 'lucide-react';
...
const mockAlumni: Alumni[] = [
  { id: '1', name: 'Oishi Regaspi', email: 'oishi@email.com', department: 'CSE', program: 'BSIT', batchYear: 2020, employmentStatus: 'Employed', currentCompany: 'Tech Corp', position: 'Software Developer', verified: true },
  { id: '2', name: 'Rui Delmo', email: 'rui.delmo@email.com', department: 'CTHM', program: 'BSHM', batchYear: 2019, employmentStatus: 'Self-Employed', currentCompany: 'Own Business', position: 'Entrepreneur', verified: true },
  { id: '3', name: 'Luwie Enolpe', email: 'luwie@email.com', department: 'BAA', program: 'BSA', batchYear: 2021, employmentStatus: 'Employed', currentCompany: 'Finance Inc', position: 'Accountant', verified: false },
  { id: '4', name: 'Ashi Capistrano', email: 'ashi@email.com', department: 'CSE', program: 'BSCS', batchYear: 2020, employmentStatus: 'Pursuing Studies', verified: true },
  { id: '5', name: 'Rui Elmido', email: 'rui.elmido@email.com', department: 'CTHM', program: 'BSTM', batchYear: 2018, employmentStatus: 'Employed', currentCompany: 'Hotel Grand', position: 'Manager', verified: true },
  { id: '6', name: 'Oii Partosa', email: 'oii@email.com', department: 'CSE', program: 'BSIT', batchYear: 2021, employmentStatus: 'Employed', currentCompany: 'StartUp Inc', position: 'Developer', verified: true },
  { id: '7', name: 'Oishi Regaspi', email: 'oishi2@email.com', department: 'BAA', program: 'BSBA', batchYear: 2020, employmentStatus: 'Self-Employed', verified: true },
];
